...
-   `MP <http://mpcraft.cn>`_ 萌萌的MP子，微电子科班，但在做软件（竟然和我一样）
-   `Eden Chen <https://vendredii.github.io>`_ 可恶的资本家，生态学，最近在荷兰读博
-   `Bob <https://yyccli.github.io>`_ 可爱的学弟，超级喜欢他的文笔，最近在搞GPU和AI加速
-   `Dudu <https://star-du.github.io/eleventy-blog>`_ 爱思考的纯文学爱好者，阅读量浩如烟海，自学转码
